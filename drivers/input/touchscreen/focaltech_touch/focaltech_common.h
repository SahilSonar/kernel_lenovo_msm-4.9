...
#else
#define FTS_DEBUG(fmt, args...) printk(KERN_INFO "[FTS][Info]"fmt"\n", ##args);
#endif
...
#define FTS_ERROR(fmt, args...) printk(KERN_INFO "[FTS][Info]"fmt"\n", ##args)
#define FTS_DEBUG_LOG(fmt, args...) do {\
                                      if(debug_open)\
                                          printk(KERN_INFO "[FTS][%s][%d]"fmt"\n", __func__, __LINE__, ##args);\
                                  }while(0)
