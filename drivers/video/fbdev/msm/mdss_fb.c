...
#include <linux/dma-buf.h>
//+TABV7-4781 fast screen on yanglong.wt 
...
static int mdss_fb_register(struct msm_fb_data_type *mfd)
{
	...
	atomic_set(&mfd->resume_pending, 0);//+TABV7-4781 fast screen on yanglong.wt 
    ...
    init_waitqueue_head(&mfd->resume_wait_q);//+TABV7-4781 fast screen on yanglong.wt 
